...
#define FAN_RPM_Pin GPIO_PIN_10
#define FAN_RPM_GPIO_Port GPIOA
#define FAN_RPM_EXTI_IRQn EXTI15_10_IRQn
#define NPN_PWM_Pin GPIO_PIN_4
#define NPN_PWM_GPIO_Port GPIOB
#define ROT_BUT_Pin GPIO_PIN_5
