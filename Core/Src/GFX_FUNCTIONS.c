...
#define PEPO1_1_PNG_HEIGHT 67
#define PEPO1_1_PNG_WIDTH 72
...
void drawRectThickness(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color, uint8_t thickness)
{
...
void drawRoundRectThickness(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color, uint8_t thickness)
{
    // Loop 'thickness' times
    for(uint8_t i = 0; i < thickness; i++)
    {
